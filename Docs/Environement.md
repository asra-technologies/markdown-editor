...
In order to deploy the application in developpement, the dev mode must be enabled on windows. If visual studio doesn't ask to activate [follow this guide](https://docs.microsoft.com/en-us/windows/uwp/get-started/enable-your-device-for-development).
